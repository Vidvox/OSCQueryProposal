 ...
 * In addition to describing attributes of remote OSC methods, JSON string:value pairs can be used to convey messages about specific events that clients need to respond to:
